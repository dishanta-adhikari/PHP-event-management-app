    ...
    if (empty($email) || empty($pass)) {
        ...
        if ($res) {
            if ($res["user_type"] === "admin") {   //user type admin or club
                ...
                header("location: " . $appUrl . "/src/Views/club/dashboard");
                exit();
            }
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="<?php echo $appUrl; ?>/public/assets/CSS/navbar.css">
    <link rel="stylesheet" href="<?php echo $appUrl; ?>/public/assets/CSS/carousel.css">
    <link rel="stylesheet" href="<?php echo $appUrl; ?>/public/assets/CSS/login.css">
    <link rel="stylesheet" href="<?php echo $appUrl; ?>/public/assets/CSS/aboutpop.css">
    <link rel="stylesheet" href="<?php echo $appUrl; ?>/public/assets/CSS/contactmodal.css">
    <link rel="stylesheet" href="<?php echo $appUrl; ?>/public/assets/CSS/footer.css">
...
<body>
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000">
                <img src="<?php echo $appUrl; ?>/public/assets/images/DSC_7401_1-scaled.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?php echo $appUrl; ?>/public/assets/images/DSC_8915-1536x864.jpg" class="d-block w-100" alt="...">
            </div>

            <div class="carousel-item">
                <img src="<?php echo $appUrl; ?>/public/assets/images/DSC_7433_1-1536x864.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?php echo $appUrl; ?>/public/assets/images/DSC_8798-scaled.jpg" class="d-block w-100" alt="...">
            </div>
    ...
    <div class="container.fluid">
        <div class="loginbackground">
            <form class="mx-auto" id="loginModal" method="POST">
                ...
                <p>go to <a href="<?php echo $appUrl; ?>">Home</a></p>
            </form>
        </div>
    </div>
    <!--pop login script -->
    <script src="<?php echo $appUrl; ?>/public/assets/JS/login.js"></script>
                ...
                ?>
                    <div class="col-md-3 mt-3 column bg-light">
                        <div class="card mt-5 bg-light" style="width: 100%; height:auto;">
                            ...
                            $row0 = $programController->getProgramImage($user_id);

                            ?>
                            <img class="admin-img" src="<?php echo $appUrl . '/public' . $row0['image']; ?>" width="100%" alt="image"></a>
                            ...
                            <div class="card-body text-center">
                                ...
                                <p>
                                    ...
                                    $res = $userController->getUserById($user_id);

                                    if ($res) {

                                        echo $res['name']; // Display the retrieved name
                                    }
                                    ?>
                                </p>
                                <div class="button-container">
                                    <button class="btn details" onclick="window.location.href='<?php echo $appUrl; ?>/src/Views/user/programes/details?id=<?php echo $row['program_id']; ?>'">Details</button>
                                    <button class="btn btn-primary program_register" onclick="window.location.href='<?php echo $appUrl; ?>/src/Views/user/programes/register?id=<?php echo $row['program_id']; ?>'">Register</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- script 'About' -->
    <script src="<?php echo $appUrl; ?>/public/assets/JS/popabout.js"></script>
    ...
    <!-- Contact us script -->
    <script src="<?php echo $appUrl; ?>/public/assets/JS/contact.js"></script>
